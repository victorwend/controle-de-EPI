...
Neste momento, o repositório contém **somente a estrutura organizada do projeto**. Ainda não há código-fonte.
...
| `frontend` | Espaço reservado para a interface do sistema |
